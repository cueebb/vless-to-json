...
`;
  ...
  const commandExample = `python convert_vless.py keys.txt --full -o config.json`;
    ...
    <div className="bg-slate-800/90 border border-slate-700/80 rounded-2xl p-5 shadow-sm space-y-5">
      ...
      <div className="bg-slate-900/90 p-4 rounded-xl border border-slate-700/60 space-y-3">
        ...
        <div className="text-xs text-slate-400 space-y-1 pl-1">
          <p>• <strong className="text-slate-200">Convert Outbounds Only:</strong> <code className="text-indigo-300">python convert_vless.py my_keys.txt -o outbounds.json</code></p>
          <p>• <strong className="text-slate-200">Full Relay Mode (Ports 50000+):</strong> <code className="text-indigo-300">python convert_vless.py my_keys.txt --full -o config.json</code></p>
          <p>• <strong className="text-slate-200">Custom Start Port & Protocol:</strong> <code className="text-indigo-300">python convert_vless.py my_keys.txt --full --start-port 50000 --inbound-protocol socks</code></p>
        </div>
      </div>
